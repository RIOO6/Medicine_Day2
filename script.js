...
const translations = {
  ar: {
    ...
    cta_register: "تسجيل",
    hero_kicker: "وزارة الصحة الاتحادية — الإدارة العامة للصيدلةة",
    ...
    creator_credit_label: "تصميم وتطوير هذا الموقع بواسطة",
    ...
    developer_credit_label: "هذا الموقع من تصميم وتطوير",
  ...
  en: {
    ...
    creator_credit_label: "Designed and developed by",
    ...
    speaker_name_5: "Dr. Khalid Hamed",
    ...
    developer_credit_label: "This website was designed and developed by",
    ...
    sessions: [
      {
        ...
        desc: {
          ar: "الممارسة الصيدلانية ومسار الصيدلي — د. نجم الدين أحمد المجذوب؛ التخصصات الصيدلانية: التحديات والفرص — د. خالد حامد؛ التصنيع الدوائي والخارطة الاستثمارية والنباتات الطبية — بروفيسور عاصم يوسف؛ الصيدلة والتحول الرقمي — د. جمال خلف الله؛ إضاءات من منصاتنا الرقمية على أفضل المشاركات؛ مناقشة تفاعلية وقراءة التوصيات النهائية.",
          en: "Pharmacy Practice & the Pharmacist's Career Path — Dr. Najm Aldeen Ahmed Elmagzoub; Pharmaceutical Specialties: Challenges & Opportunities — Dr. Khalid Hamed; Pharmaceutical Manufacturing, Investment Roadmap & Medicinal Plants — Prof. Asim Yousif; Pharmacy & Digital Transformation — Dr. Jamal Khalafalla; highlights from our digital platforms' top contributions; interactive discussion and final recommendations.",
        },
      },
      {
        time: "13:30 – 14:30",
